...
import example.wxx.com.essayjoke.test.adapter.CityAdapter;
import example.wxx.com.essayjoke.test.bean.CityBean;
...
public class TestIndexListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRv.addItemDecoration(new DividerItemDecoration(TestIndexListActivity.this, DividerItemDecoration.VERTICAL_LIST));
