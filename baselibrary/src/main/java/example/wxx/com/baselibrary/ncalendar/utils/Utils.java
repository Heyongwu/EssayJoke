package example.wxx.com.baselibrary.ncalendar.utils;
...
public class Utils {
     ...
     * @return
     */
    public static boolean isAfter(DateTime dateTime) {
        return dateTime.toLocalDate().isAfter(new DateTime().toLocalDate());
    }
