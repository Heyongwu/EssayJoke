package example.wxx.com.baselibrary.ncalendar.view;
...
public class MonthView extends CalendarView {
    ...
    protected DateTime mTodayDateTime;
...
//                    如果结束时间不为null,则设置今后的日期为空
                    if (mEndDateTime != null) {
                        if (Utils.isAfter(dateTime)) {
    ...
    public DateTime getTodayDateTime() {
        return mTodayDateTime;
    }

    public void setTodayDateTime(DateTime todayDateTime) {
